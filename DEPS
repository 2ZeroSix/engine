...
vars = {
  ...
  'dart_revision': 'c9d4d0d38ec7192d8bfebb82eb4cfc3cef7c9221',
...
deps = {
  ...
  'src/third_party/dart':
   'https://github.com/2ZeroSix' + '/sdk.git' + '@' + Var('dart_revision'),
     ...
     'packages': [
       {
        ...
        'version': 'hODX8Qi_7J5kwKp4SwpB-p81Ans71f3AUS-rmDlcx9UC'
       }
     ],
